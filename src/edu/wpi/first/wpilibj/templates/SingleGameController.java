...
/**
 * The second game pad controller mirrors all the commands on the 
...
public class SingleGameController extends Joystick implements GameController {
    ...
    public double getY(Hand hand) {
        //TODO: This is probably better mapped to the second axis of the left joystick.
  ...
  public double getLeftJoystickLeftRight() {
    return getRawAxis(3); // DEBUG: I don't know the actual axis.
  }
}
